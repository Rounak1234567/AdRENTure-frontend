...
function BookingCar() {
  ...
  async function displayRazorpay() {
    ...
    //http://localhost:2345/api/bookings/bookcar/${totalAmount}`
		...
		const data = await fetch(`https://adrenture.onrender.com/api/bookings/bookcar/${totalAmount}`, { method: 'POST',  headers: {'Content-Type': 'application/json'},body: JSON.stringify(bookingData) }).then((t) =>
			t.json()
		)
